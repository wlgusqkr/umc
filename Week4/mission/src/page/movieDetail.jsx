...
const MovieDetail = () => {
  ...
  if (isCreditLoading === true || isDetailLoading === true) {
    return (
      <div style={{ display : 'flex', width: '100%', height: '100%', flexWrap: 'wrap', justifyContent: 'space-evenly'}}>
        <CardSkeletonList number={28}/>
      </div>
    )
  }

  if (isCreditError === true || isDetailError === true) {
    return (
      <div>
        <h2>에러났습니다.</h2>
      </div>
